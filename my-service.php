    ...
    error_log("Experience Years: $experienceYears");
        ...
        try {
            if ($isEditing) {
                ...
                ");
                $stmt->execute([
                    $businessName, $categoryId, $location, $latitude, $longitude, $hourlyRate, 
                    $experienceYears, $description, json_encode($workingDays), $workingHoursStart, 
                    $workingHoursEnd, $bestCallTime, json_encode($tags), $profilePhotoPath, 
                    $isActive, $isVerified, $isSkilled, $currentUser['id']
                ]);
